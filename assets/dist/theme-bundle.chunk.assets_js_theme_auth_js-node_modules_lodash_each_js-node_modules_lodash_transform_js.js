(self["webpackChunkbigcommerce_cornerstone"] = self["webpackChunkbigcommerce_cornerstone"] || []).push([["assets_js_theme_auth_js-node_modules_lodash_each_js-node_modules_lodash_transform_js"],{
...
var Auth = /*#__PURE__*/function (_PageManager) {
  ...
  _proto.registerLoginValidation = function registerLoginValidation($loginForm) {
    var _this2 = this;
    var loginModel = _common_models_forms__WEBPACK_IMPORTED_MODULE_7__["default"];
    this.loginValidator = (0,_common_nod__WEBPACK_IMPORTED_MODULE_5__["default"])({
  ...
  _proto.registerForgotPasswordValidation = function registerForgotPasswordValidation($forgotPasswordForm) {
    var _this3 = this;
    this.forgotPasswordValidator = (0,_common_nod__WEBPACK_IMPORTED_MODULE_5__["default"])({
      submit: '.forgot-password-form input[type="submit"]'
    });
    this.forgotPasswordValidator.add([{
      selector: '.forgot-password-form input[name="email"]',
      validate: function validate(cb, val) {
        var result = _common_models_forms__WEBPACK_IMPORTED_MODULE_7__["default"].email(val);
        cb(result);
      },
      errorMessage: this.context.useValidEmail
    }]);
  ...
  _proto.registerNewPasswordValidation = function registerNewPasswordValidation() {
    ...
    var newPasswordValidator = (0,_common_nod__WEBPACK_IMPORTED_MODULE_5__["default"])({
    ...
    _common_form_utils__WEBPACK_IMPORTED_MODULE_8__.Validators.setPasswordValidation(newPasswordValidator, passwordSelector, password2Selector, this.passwordRequirements);
  };
  _proto.registerCreateAccountValidator = function registerCreateAccountValidator($createAccountForm) {
    var validationModel = (0,_common_form_validation__WEBPACK_IMPORTED_MODULE_6__["default"])($createAccountForm);
    var createAccountValidator = (0,_common_nod__WEBPACK_IMPORTED_MODULE_5__["default"])({
    ...
    if ($stateElement) {
      ...
      (0,_common_state_country__WEBPACK_IMPORTED_MODULE_4__["default"])($stateElement, this.context, function (err, field) {
        if (err) {
          throw new Error(err);
        }
        var $field = $(field);
        ...
        if ($field.is('select')) {
          $last = field;
          _common_form_utils__WEBPACK_IMPORTED_MODULE_8__.Validators.setStateCountryValidation(createAccountValidator, field);
        } else {
    ...
    if ($emailElement) {
      ...
      _common_form_utils__WEBPACK_IMPORTED_MODULE_8__.Validators.setEmailValidation(createAccountValidator, emailSelector);
    }
    if ($passwordElement && $password2Element) {
      createAccountValidator.remove(passwordSelector);
      createAccountValidator.remove(password2Selector);
      _common_form_utils__WEBPACK_IMPORTED_MODULE_8__.Validators.setPasswordValidation(createAccountValidator, passwordSelector, password2Selector, this.passwordRequirements);
    }
  ...
  _proto.onReady = function onReady() {
    var $createAccountForm = (0,_common_form_utils__WEBPACK_IMPORTED_MODULE_8__.classifyForm)(this.formCreateSelector);
    var $loginForm = (0,_common_form_utils__WEBPACK_IMPORTED_MODULE_8__.classifyForm)('.login-form');
    var $forgotPasswordForm = (0,_common_form_utils__WEBPACK_IMPORTED_MODULE_8__.classifyForm)('.forgot-password-form');
    var $newPasswordForm = (0,_common_form_utils__WEBPACK_IMPORTED_MODULE_8__.classifyForm)('.new-password-form'); // reset password
